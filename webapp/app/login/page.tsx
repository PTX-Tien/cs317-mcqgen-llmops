    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 to-slate-700">
      <Card className="w-full max-w-md shadow-2xl">
        <CardHeader className="text-center space-y-2">
          ...
          <CardDescription>
            Hệ thống sinh câu hỏi trắc nghiệm tự động<br />
            <span className="text-xs text-slate-400">ĐH Công nghệ Thông tin ĐHQG-HCM</span>
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="mt-4 p-3 bg-slate-50 rounded-lg text-xs text-slate-500 space-y-1">
            <p><strong>Giảng viên:</strong> giaovien / gv2026</p>
            <p><strong>Sinh viên:</strong> sinhvien / sv2026</p>
          </div>
        </CardContent>
      </Card>
    </div>
